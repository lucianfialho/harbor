        ...
        "useDocsSearch.useOnChange": ()=>{
            ...
            async function run() {
                ...
                if (client.type === "fetch") {
                    const { fetchDocs } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/fetch-2XFMBLBA.js [app-client] (ecmascript, async loader)");
                    return fetchDocs(debouncedValue, client);
                }
                if (client.type === "algolia") {
                    const { searchDocs } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/algolia-IZEDLPHE.js [app-client] (ecmascript, async loader)");
                    return searchDocs(debouncedValue, client);
                }
                if (client.type === "orama-cloud") {
                    const { searchDocs } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/orama-cloud-74FM25SB.js [app-client] (ecmascript, async loader)");
                    return searchDocs(debouncedValue, client);
                }
                if (client.type === "static") {
                    const { search: search2 } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/static-A2YJ5TXV.js [app-client] (ecmascript, async loader)");
                    return search2(debouncedValue, client);
                }
                if (client.type === "mixedbread") {
                    const { search: search2 } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/mixedbread-RAHDVXGJ.js [app-client] (ecmascript, async loader)");
                    return search2(debouncedValue, client);
                }
...
;
;
var useEffectEvent = "useEffectEvent" in __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ ? ({
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__
}).useEffectEvent : (callback)=>{
    const ref = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useRef(callback);
    ref.current = callback;
...
//# sourceMappingURL=node_modules_be59c6e5._.js.map